...
| [`2026-08-16-sidebar-rename-delete-bulk-select.md`](specs/2026-08-16-sidebar-rename-delete-bulk-select.md) | feature-spec | ACCEPTED — the repo owner confirmed § 5 OQ-1 (launch-time-only tab-title aliasing accepted); implementation complete and verified | #80 |
