...
- **Tooling unavailable to this dispatch:** `Bash`, `mcp__github__*`, and `Write`-to-GitHub of any kind. Issue #84's state was obtained by fetching its public page (https://github.com/cbeaulieu-gt/vscode-claude-conductor/issues/84, fetched 2026-07-31), not through the API. No issue was created, no comment posted, no acceptance criterion ticked.
